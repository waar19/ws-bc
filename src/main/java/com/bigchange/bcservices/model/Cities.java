...
@NamedQueries({
    ...
    @NamedQuery(name = "Cities.findByCode", query = "SELECT c FROM Cities c WHERE c.code = :code"),
    @NamedQuery(name = "Cities.findByDepartment", query = "SELECT c FROM Cities c WHERE c.department = :department"),
...
public class Cities implements Serializable {
    ...
    public String toString() {
        return "com.bigchange.bcservices.model.Cities[ id=" + id + " ]";
    }
